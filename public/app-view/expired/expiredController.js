app.controller('ExpiredController', ['$rootScope','$scope', '$location', 'HttpService', '$http','$window', 'FlashService', 'MetaService', function( $rootScope,$scope,$location,HttpService,$http,$window,FlashService, MetaService ){
    var vm = this;
