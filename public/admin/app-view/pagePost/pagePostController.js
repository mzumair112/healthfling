app.controller('PagePostController', ['$rootScope','$scope','$location' ,'HttpService', '$window', function( $rootScope,$scope,$location,HttpService, $window ){
    var vm = this;
    ...
    $scope.editPost = function (post) {
      $window.open('https://www.healthyfling.com/#/edit/' + post._id, '_blank');
    }
